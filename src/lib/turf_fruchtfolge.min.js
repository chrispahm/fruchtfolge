...
},{"geojson-area":18}],2:[function(require,module,exports){
...
},{"@turf/helpers":8,"geojson-normalize":19,"jsts":21}],4:[function(require,module,exports){
function centerOfMass(e){if("Feature"===e.type&&"Polygon"===e.geometry.type){var r=[];each(e,function(e){r.push(e)});var t,o,n,u,i,c,a,f,p=centroid(e),d=p.geometry.coordinates,s=0,l=0,v=0,x=r.map(function(e){return[e[0]-d[0],e[1]-d[1]]});for(t=0;t<r.length-1;t++)o=x[t],u=o[0],c=o[1],n=x[t+1],i=n[0],a=n[1],f=u*a-i*c,v+=f,s+=(u+i)*f,l+=(c+a)*f;if(0===v)return p;var h=.5*v,m=1/(6*h);return point([d[0]+m*s,d[1]+m*l])}var q=convex(explode(e));return q?module.exports(q):centroid(e)}var each=require("@turf/meta").coordEach,centroid=require("@turf/centroid"),convex=require("@turf/convex"),explode=require("@turf/explode"),point=require("@turf/helpers").point;module.exports=centerOfMass;

},{"@turf/centroid":5,"@turf/convex":6,"@turf/explode":7,"@turf/helpers":8,"@turf/meta":10}],5:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/meta":10,"convex-hull":14}],7:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/meta":10}],8:[function(require,module,exports){
...
},{"jsts":21}],10:[function(require,module,exports){
...
},{"./lib/ch1d":15,"./lib/ch2d":16,"./lib/chnd":17}],15:[function(require,module,exports){
...
},{"monotone-convex-hull-2d":22}],17:[function(require,module,exports){
...
},{"affine-hull":12,"incremental-convex-hull":20}],18:[function(require,module,exports){
...
},{"wgs84":31}],19:[function(require,module,exports){
...
},{"robust-orientation":23}],23:[function(require,module,exports){
...
},{"robust-scale":24,"robust-subtract":25,"robust-sum":26,"two-product":28}],24:[function(require,module,exports){
...
},{"two-product":28,"two-sum":29}],25:[function(require,module,exports){
"use strict";function scalarScalar(r,t){var a=r+t,n=a-r,u=a-n,e=t-n,c=r-u,o=c+e;return o?[o,a]:[a]}function robustSubtract(r,t){var a=0|r.length,n=0|t.length;if(1===a&&1===n)return scalarScalar(r[0],-t[0]);var u,e,c=a+n,o=new Array(c),l=0,s=0,f=0,b=Math.abs,h=r[s],i=b(h),v=-t[f],S=b(v);i<S?(e=h,s+=1,s<a&&(h=r[s],i=b(h))):(e=v,f+=1,f<n&&(v=-t[f],S=b(v))),s<a&&i<S||f>=n?(u=h,s+=1,s<a&&(h=r[s],i=b(h))):(u=v,f+=1,f<n&&(v=-t[f],S=b(v)));for(var g,d,m,p,w,x=u+e,y=x-u,A=e-y,M=A,j=x;s<a&&f<n;)i<S?(u=h,s+=1,s<a&&(h=r[s],i=b(h))):(u=v,f+=1,f<n&&(v=-t[f],S=b(v))),e=M,x=u+e,y=x-u,A=e-y,A&&(o[l++]=A),g=j+x,d=g-j,m=g-d,p=x-d,w=j-m,M=w+p,j=g;for(;s<a;)u=h,e=M,x=u+e,y=x-u,A=e-y,A&&(o[l++]=A),g=j+x,d=g-j,m=g-d,p=x-d,w=j-m,M=w+p,j=g,s+=1,s<a&&(h=r[s]);for(;f<n;)u=v,e=M,x=u+e,y=x-u,A=e-y,A&&(o[l++]=A),g=j+x,d=g-j,m=g-d,p=x-d,w=j-m,M=w+p,j=g,f+=1,f<n&&(v=-t[f]);return M&&(o[l++]=M),j&&(o[l++]=j),l||(o[l++]=0),o.length=l,o}module.exports=robustSubtract;

},{}],26:[function(require,module,exports){
"use strict";function scalarScalar(r,a){var n=r+a,e=n-r,t=n-e,l=a-e,o=r-t,u=o+l;return u?[u,n]:[n]}function linearExpansionSum(r,a){var n=0|r.length,e=0|a.length;if(1===n&&1===e)return scalarScalar(r[0],a[0]);var t,l,o=n+e,u=new Array(o),i=0,s=0,c=0,f=Math.abs,h=r[s],v=f(h),S=a[c],g=f(S);v<g?(l=h,s+=1,s<n&&(h=r[s],v=f(h))):(l=S,c+=1,c<e&&(S=a[c],g=f(S))),s<n&&v<g||c>=e?(t=h,s+=1,s<n&&(h=r[s],v=f(h))):(t=S,c+=1,c<e&&(S=a[c],g=f(S)));for(var m,p,x,E,b,d=t+l,w=d-t,y=l-w,A=y,M=d;s<n&&c<e;)v<g?(t=h,s+=1,s<n&&(h=r[s],v=f(h))):(t=S,c+=1,c<e&&(S=a[c],g=f(S))),l=A,d=t+l,w=d-t,y=l-w,y&&(u[i++]=y),m=M+d,p=m-M,x=m-p,E=d-p,b=M-x,A=b+E,M=m;for(;s<n;)t=h,l=A,d=t+l,w=d-t,y=l-w,y&&(u[i++]=y),m=M+d,p=m-M,x=m-p,E=d-p,b=M-x,A=b+E,M=m,s+=1,s<n&&(h=r[s]);for(;c<e;)t=S,l=A,d=t+l,w=d-t,y=l-w,y&&(u[i++]=y),m=M+d,p=m-M,x=m-p,E=d-p,b=M-x,A=b+E,M=m,c+=1,c<e&&(S=a[c]);return A&&(u[i++]=A),M&&(u[i++]=M),i||(u[i++]=0),u.length=i,u}module.exports=linearExpansionSum;
...
},{"bit-twiddle":13,"union-find":30}],28:[function(require,module,exports){
...
module.exports={bbox:require("@turf/bbox"),union:require("@turf/union"),centerOfMass:require("@turf/center-of-mass"),area:require("@turf/area"),intersect:require("@turf/intersect"),buffer:require("@turf/buffer")};
},{"@turf/area":1,"@turf/bbox":2,"@turf/buffer":3,"@turf/center-of-mass":4,"@turf/intersect":9,"@turf/union":11}]},{},[32])(32)
});